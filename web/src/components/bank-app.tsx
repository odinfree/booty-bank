        ...
        <div className="bank-content">
          ...
          {view === "privacy" && (
            <div className="app-page privacy-page">
              ...
              <div className="privacy-control-grid"><article><span>PQ-READY ACCOUNT</span><h5>FALCON-512</h5><p>POST-QUANTUM ACCOUNT SIGNATURES.</p><b>LOCAL TESTS / NOT DEPLOYED</b></article><article><span>INCOME DISCLOSURE</span><h5>MINIMUM PACKET</h5><p>SCORE + BAND ONLY. PAYOUTS STAY OFFCHAIN.</p><b>DEMO LIVE</b></article><article><span>MONEY MOVEMENT</span><h5>SHIELDED PAYOUTS</h5><p>PRIVATE PAYOUTS ON STRK20.</p><b>NEXT BUILD</b></article></div>
