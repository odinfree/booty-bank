export default function SiteHeader() {
  return (
    <header className="site-header">
      ...
      <nav aria-label="Primary navigation"><a href="/app/">ACCOUNT</a><a href="/credit/">CREDIT</a><a href="/privacy/">PRIVACY</a><a href="/details/">DETAILS</a><a href="/#waitlist">WAITLIST</a></nav>
