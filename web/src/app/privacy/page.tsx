...
export default function PrivacyPage() {
  return (
    <main className="dossier-route dossier-purple"><SiteHeader />
      <section className="dossier-page-head"><span>FILE / 03</span><span>PRIVACY + SECURITY</span><a href="/">CLOSE FILE ×</a><h1>PRIVATE.<br />POST-<br />QUANTUM.</h1><p>MINIMUM DATA.<br />FALCON-512 AUTH.</p></section>
