...
export default function CreditPage() {
  ...
  return (
    <main className="dossier-route dossier-green"><SiteHeader />
      <section className="dossier-page-head"><span>02 / CREDIT</span><span>PRIVATE CREDIT</span><a href="/">BACK HOME ×</a><h1>CREDIT<br />WITHOUT<br />EXPOSURE.</h1><p>EXACT PAYOUTS STAY PRIVATE.</p></section>
      <ol className="case-rows case-rows-page">
        <li aria-label="Invisible income, solved: verified payout months count.">
          <div className="case-row-static" aria-hidden="true"><i>01</i><span><s>INVISIBLE INCOME.</s> <b>PAYOUT MONTHS COUNT.</b></span></div>
        </li>
        <li aria-label="Full exposure, solved: the lender sees score and band only.">
          <div className="case-row-static" aria-hidden="true"><i>02</i><span><s>FULL EXPOSURE.</s> <b>SCORE + BAND ONLY.</b></span></div>
        </li>
      </ol>
